...
Each of the trading strategies below were implemented into the stock simulation program. 
They all function algorithmically and aim to optimize returns as the market progresses. 
...
\hline
\end{tabular}
\caption{Performance comparison of investment strategies over the extended backtesting period}
\end{table}
